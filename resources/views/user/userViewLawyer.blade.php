        ...
        <div class="container">
            <div class="ad-details">
                ...
                <div class="row">
                    <center>
                    <br>
                    <a href="{{ route('lawyerVedio') }}"><span id="icon2"   class="fa fa-video-camera" style="font-size:35px;color:black;padding-right:25px"></span></a> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp         
